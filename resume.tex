...
\begin{itemize}
\item Maintain production systems of our website, ERP, and internal tooling
services. Extend or implement new modules in our ERP and website to meet custom business
requirements. Implement in-house auditing tools for analytics and fault prevention.
Maintain Google business tools, such as Google Scripts, for business intelligence reporting.
\end{itemize}

\divider

\cvevent{QA Engineer}{Logic Supply, Inc.}{March 2017 -- November 2017}{South Burlington, VT}
\begin{itemize}
\item Ensure code quality for the business’ e-commerce website and ERP system through
manual testing methods, user acceptance testing groups, and by reviewing and
updating unit tests written by myself or the development team.
\end{itemize}
